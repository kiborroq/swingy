...
public enum HeroType {
	ALCHEMIST("Alchemist", "Female",
			...
			"/images/avatars/Neela.png", "/images/miniatur/Alchemist.png", 1, 1, 2, 15, 15, 20),
	KNIGHT("Knight", "Male",
			...
			"/images/avatars/Orrin.png", "/images/miniatur/Knight.png", 2, 1, 1, 20, 20, 10),
	NECROMANCER("Necromancer", "Male",
			...
			"/images/avatars/Sandro.png", "/images/miniatur/Necromancer.png", 2, 0, 2, 20, 10, 20),
	DEATH_KNIGHT("Death Knight", "Female",
			...
			"/images/avatars/Tamika.png", "/images/miniatur/DeathKnight.png", 1, 1, 2, 20, 20, 10),
	WIZARD("Wizard", "Male",
			...
			"/images/avatars/Theodorus.png", "/images/miniatur/Wizard.png", 1, 1, 2, 15, 15, 20),
	CLERIC("Cleric", "Female",
			...
			"/images/avatars/Sanya.png", "/images/miniatur/Cleric.png", 1, 1, 2, 15, 15, 20),
	DEMONIAC("Demoniac", "Male",
				   ...
				   "Calh.png", "/images/miniatur/Demoniac.png", 2, 2, 1, 25, 15, 10),
	DRUID("Druid", "Male",
			...
			"/images/avatars/Elleshar.png", "/images/miniatur/Druid.png", 1, 2, 2, 10, 20, 20),
	OVERLORD("Overlord", "Male",
			...
			"/images/avatars/Ajit.png", "/images/miniatur/Overlord.png", 2, 2, 1, 20, 20, 10);
